...
<div class="loading-overlay" id="loadingOverlay"> <!-- Add an ID to the overlay for easier access in JavaScript -->
...
<div class="container">
   ...
   <div class="content" >
      ...
      <p style='color:#fff; font-style:italic; font-size:1.2em;'>Go to Dashboard to check your stats</p>
